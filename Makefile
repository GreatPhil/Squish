...
#
#    default: The default target: Compiles $(PROG) and whatever it depends on.
#
...
SRCS = squish.java compressor.java decompressor.java TreeMaker.java TreeConverter.java byteConverter.java FreqElement.java HuffTree.java ByteNode.java ByteHash.java
